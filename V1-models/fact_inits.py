...
def save_model(args, fact1_model, fact2_model):
    src= "/home/mila/v/vivian.white/scratch/v1-models/saved-models/correct_twins/"
    ...
    #os.chdir(trial_dir)
    trial_dir = model_dir 
    torch.save(fact1_model.state_dict(), trial_dir+ "/fact1_model.pt")
    torch.save(fact2_model.state_dict(), trial_dir+ "/fact2_model.pt")
