...
def save_model(args, model):
    src = "/home/mila/m/muawiz.chaudhary/scratch/v1-models/saved-models/CIFAR10_pytorch/seed_{}".format(args.seed)
...
run = wandb.init(project="random_project", config=args,
        group="seeds_pytorch_cifar_experiments_final", name=run_name, dir=wandb_dir)
