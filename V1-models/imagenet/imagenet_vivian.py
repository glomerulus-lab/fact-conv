...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if True:
        path    = os.path.join("/network/scratch/v/vivian.white/v1-models/saved-models/imagenet/mila_retry_fact_resnet_width_{}/latest.pth.tar".format(int(args.width_scale)))
        print(path)
