...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='dataset of model')
    args = parser.parse_args()
    
    src = "/research/harris/vivian/v1-models/saved-models/" + args.dataset + "/" + args.name
    ...
    print("Loss Err: " + str(loss_err))
    print("Accuracy: " + str(avg_acc))
    print("Acc Err: " + str(acc_err))
