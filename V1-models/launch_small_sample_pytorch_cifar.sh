...
sbatch setoff_small_sample_pytorch_cifar.sh False False V1 Pytorch_small_sample_Cifar_Resnet_V1_LSLC
sbatch setoff_small_sample_pytorch_cifar.sh True False V1 Pytorch_small_sample_Cifar_Resnet_V1_USLC
sbatch setoff_small_sample_pytorch_cifar.sh False True V1 Pytorch_small_sample_Cifar_Resnet_V1_LSUC
sbatch setoff_small_sample_pytorch_cifar.sh True True V1 Pytorch_small_sample_Cifar_Resnet_V1_USUC

sbatch setoff_small_sample_pytorch_cifar.sh False False default Pytorch_small_sample_Cifar_Resnet_default_LSLC
sbatch setoff_small_sample_pytorch_cifar.sh True False default Pytorch_small_sample_Cifar_Resnet_default_USLC
sbatch setoff_small_sample_pytorch_cifar.sh False True default Pytorch_small_sample_Cifar_Resnet_default_LSUC
sbatch setoff_small_sample_pytorch_cifar.sh True True default Pytorch_small_sample_Cifar_Resnet_default_USUC
