...
for i in {0..9}
do
  sbatch setoff_pytorch_cifar.sh False False V1 Pytorch_Cifar_Resnet_V1_LSLC $i 
  sbatch setoff_pytorch_cifar.sh False False default Pytorch_Cifar_Resnet_default_LSLC $i

  sbatch setoff_pytorch_cifar.sh True True V1 Pytorch_Cifar_Resnet_V1_USUC $i 
  sbatch setoff_pytorch_cifar.sh True True default Pytorch_Cifar_Resnet_default_USUC $i

  sbatch setoff_pytorch_cifar.sh True False V1 Pytorch_Cifar_Resnet_V1_USLC $i 
  sbatch setoff_pytorch_cifar.sh True False default Pytorch_Cifar_Resnet_default_USLC $i

  sbatch setoff_pytorch_cifar.sh False True V1 Pytorch_Cifar_Resnet_V1_LSUC $i 
  sbatch setoff_pytorch_cifar.sh False True default Pytorch_Cifar_Resnet_default_LSUC $i
done
