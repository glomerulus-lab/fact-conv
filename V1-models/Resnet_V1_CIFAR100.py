...
def save_model(args, model, loss, accuracy):
    src = "/home/mila/m/muawiz.chaudhary/scratch/v1-models/saved-models/CIFAR100/"
...
if __name__ == '__main__':
    ...
    if args.net == "post":
        model = PostExp_Class100(args.s, args.f, args.scale, args.bias, args.freeze_spatial, args.freeze_channel, args.spatial_init).to(device)
    elif args.net == "pre":
        model = PreExp_Class100(args.s, args.f, args.scale, args.bias, args.freeze_spatial, args.freeze_channel, args.spatial_init).to(device)
