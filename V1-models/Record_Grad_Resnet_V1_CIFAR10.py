...
def save_model(args, model, loss, accuracy):
    src = "/home/mila/m/muawiz.chaudhary/scratch/v1-models/saved-models/CIFAR10_Grad/"
...
if __name__ == '__main__':
    ...
    os.chdir(wandb_dir)
    run_name = "PostExp" if args.net == "post" else "PreExp"

    run = wandb.init(project="random_project", config=args,
            group="RMS_LSLC_Grad_Comparison", name=run_name, dir=wandb_dir)
