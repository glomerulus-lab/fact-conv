...
if __name__ == '__main__':
    ...
    start = datetime.now()
    set_seeds(args.seed)
    model = Factnet_V1_CIFAR10(args.s, args.f, args.scale, args.bias, args.freeze_spatial, args.freeze_channel, args.spatial_init).to(device)
    if args.net == "replace":
        sd = model.state_dict()
        model = Replacenet_V1_CIFAR10(args.s, args.f, args.scale, args.bias, args.freeze_spatial, args.freeze_channel, args.spatial_init).to(device)
