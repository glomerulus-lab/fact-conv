...
def save_model(args, conv_model, fact_model):
    src=\
    "/home/mila/v/vivian.white/scratch/v1-models/saved-models/affine-no-bias/"
...
run = wandb.init(project="random_project", config=args,
        group="pytorch_cifar_rainbow_comparisons_affines_nobias", name=run_name, dir=wandb_dir)
