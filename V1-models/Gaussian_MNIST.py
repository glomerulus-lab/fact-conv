...
if __name__ == '__main__':
    ...
    parser.add_argument('--scale', type=int, default=1, help="scale for classical features")
    ...
    model = control_models.Gaussian_MNIST(args.hidden_dim, args.bias, args.scale).to(device)
