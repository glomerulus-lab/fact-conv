...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_samples', default=32, help="num samples to interpolate")
    ...
    fixed_batch_train = next(iter(fixed_dataloader_train))
    fixed_batch_train = fixed_batch_train[0].float().to(device) #this is the same every time
