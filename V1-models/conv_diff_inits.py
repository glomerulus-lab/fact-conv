...
def save_model(args, conv1, conv2):
    ...
    #os.chdir(trial_dir)
    trial_dir = model_dir 
    torch.save(conv1.state_dict(), trial_dir+ "/conv1.pt")
    torch.save(conv2.state_dict(), trial_dir+ "/conv2.pt")
