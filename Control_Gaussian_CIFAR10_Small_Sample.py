...
def save_model(args, model, test_loss, test_accuracy):
    src = "/research/harris/vivian/v1-models/saved-models/Control_Gaussian_CIFAR10_Small_Sample/"
...
def main():
    ...
    parser.add_argument('--name', type=str, default='new model', 
