...
class Control_Gaussian(nn.Module):
    def __init__(self, hidden_dim, bias, seed=None):
        super(Control_Gaussian, self).__init__()
...
def save_model(name, trial, model):
    src = "/research/harris/vivian/v1-models/saved-models/Control_Gaussian_MNIST/"
    model_dir =  src + name
...
if __name__ == '__main__':
    ...
    model = Control_Gaussian(args.hidden_dim, args.bias).to(device)
