...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default="Gaussian_Control", help="file name")
    parser.add_argument('--scale', type=int, default=1, help="Scale for Gaussian weights")
    ...
    model = control_models.Gaussian_CIFAR100(args.hidden_dim, args.bias, args.scale).to(device)
