...
do
  ...
  do
    echo $i
    #bash setoff_general.sh svhn.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j --resample 1 --net svhn_width4_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh svhn.py --width 2 --batchsize 512 --num_epochs  $i --seed $j --resample 1 --net svhn_width2_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh svhn.py --width 1 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width1_abs_pre_bn_aligned_resnet18 
    ...
    #bash setoff_general.sh svhn.py --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net retry_svhn_width0.25_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh svhn.py --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net retry_svhn_width0.25_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 4 --batchsize 1024 --num_epochs  $i --seed $j --resample 1 --net svhn_width4_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 2 --batchsize 512 --num_epochs  $i --seed $j --resample 1 --net svhn_width2_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 1 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width1_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.5 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.5_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net retry_svhn_width0.25_abs_pre_bn_aligned_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.125 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.125_abs_pre_bn_aligned_resnet18 
    #
    ...
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 4 --batchsize 1024 --num_epochs  $i --seed $j --resample 1 --net svhn_width4_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 2 --batchsize 512 --num_epochs  $i --seed $j --resample 1 --net svhn_width2_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 1 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width1_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 0.5 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.5_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net retry_svhn_width0.25_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 0 --statistics 1 --width 0.125 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.125_abs_pre_bn_aligned_resnet18 
 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 4 --batchsize 1024 --num_epochs  $i --seed $j --resample 1 --net svhn_width4_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 2 --batchsize 512 --num_epochs  $i --seed $j --resample 1 --net svhn_width2_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 1 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width1_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 0.5 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.5_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net retry_svhn_width0.25_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 0 --width 0.125 --batchsize 256 --num_epochs  $i --seed $j --resample 1 --net svhn_width0.125_abs_pre_bn_aligned_resnet18 
 
    ##
    #bash setoff_general.sh svhn.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j  --net svhn_width4_abs_conv_pre_bn_resnet18 
    ...
    #bash setoff_general.sh svhn.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j  --net svhn_width4_abs_fact_pre_bn_resnet18 
