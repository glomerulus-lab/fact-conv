...
do
  ...
  do
    ...
    sbatch setoff_general.sh long_cifar.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j  --resample 1 --net width4_abs_rqfree_pre_bn_aligned_resnet18 
    sbatch setoff_general.sh long_cifar.py --width 2 --batchsize 512 --num_epochs  $i --seed $j  --resample 1 --net width2_abs_rqfree_pre_bn_aligned_resnet18 
    sbatch setoff_general.sh long_cifar.py --width 1 --batchsize 256 --num_epochs  $i --seed $j  --resample 1 --net width1_abs_rqfree_pre_bn_aligned_resnet18 
    sbatch setoff_general.sh long_cifar.py --width 0.5 --batchsize 256 --num_epochs  $i --seed $j  --resample 1 --net width0.5_abs_rqfree_pre_bn_aligned_resnet18 
    sbatch setoff_general.sh long_cifar.py --width 0.25 --batchsize 256 --num_epochs  $i --seed $j  --resample 1 --net width0.25_abs_rqfree_pre_bn_aligned_resnet18 
    sbatch setoff_general.sh long_cifar.py --width 0.125 --batchsize 256 --num_epochs  $i --seed $j  --resample 1 --net width0.125_abs_rqfree_pre_bn_aligned_resnet18 
