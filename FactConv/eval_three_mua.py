...
parser.add_argument('--align_rank', type=int, default=2048, help="align_rank")
...
run = wandb.init(project="FactConv", entity="whitev4", config=args,
        group="regularize_overfitting",
        name="{}_{}_{}_{}_{}_seed_{}_align{}_abs".format(args.dataset,args.nonlin,
...
def save_model(model, net, epoch):
    storage = {"sd":model.state_dict(), "optim_sd": optimizer.state_dict(),
            "epochs": epoch}
    model_save_path=model_save_dir+args.net+"_{}_nonlin_{}_layer_{}_width_{}_seed_{}_align{}_abs".format(args.resample_freq,
            args.nonlin, args.layer, args.width, args.seed, args.align_rank)+ "_weight/" 
