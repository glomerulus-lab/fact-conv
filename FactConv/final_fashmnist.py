...
parser.add_argument('--last_epoch', type=int, default=100, help="epoch")
...
run = wandb.init(project="FactConv", config=args,
        group="final_double_testing_fmnist",
...
model_save_dir = "/home/mila/m/muawiz.chaudhary/scratch/rainbow_testing_fmnist/"
...
start_epochs  = 0
if args.resume:
    base_dir="/home/mila/m/muawiz.chaudhary/scratch/rainbow_testing_fmnist/"+args.net+"_{}_layer_{}_rank_{}_batchsize_{}_niter_{}_eps_{}".format(args.resample_freq,
            args.layer,args.rank, args.batchsize, args.niters,
