...
run = wandb.init(project="FactConv", config=args,
        #group="rainbow_mnist_testing_resampling_freq_200_rank_width_vary_epochs_1000_batchsize_1000_vary_layer",
        #group="rainbow_mnist_testing_resampling_freq_200_rank_width_vary_epochs_400_batchsize_1000_vary_layer_retry_one_more_time",
        #test_deep.py --layer 20 --rank 200 --batchsize 200 --net alignment
        #--resample_freq 0 --epochs 100
        group="final_double_testing",
...
model_save_dir = "/home/mila/m/muawiz.chaudhary/scratch/rainbow_testing/"
...
start_epochs  = 0
if args.resume:
    base_dir="/home/mila/m/muawiz.chaudhary/scratch/rainbow_testing/"+args.net+"_{}_layer_{}_rank_{}_batchsize_{}_niter_{}_eps_{}".format(args.resample_freq,
            args.layer,args.rank, args.batchsize, args.niters,
