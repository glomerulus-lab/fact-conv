...
do
  ...
  do
    echo $i
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 4 --batchsize 1024 --num_epochs  $i --seed $j  --net svhn_width4_abs_fact_pre_bn_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 2 --batchsize 512 --num_epochs  $i --seed $j  --net svhn_width2_abs_fact_pre_bn_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 1 --batchsize 256 --num_epochs  $i --seed $j  --net svhn_width1_abs_fact_pre_bn_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.5 --batchsize 256 --num_epochs  $i --seed $j  --net svhn_width0.5_abs_fact_pre_bn_resnet18 
    bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.25 --batchsize 256 --num_epochs  $i --seed $j  --net svhn_width0.25_abs_conv_pre_bn_resnet18 
    #bash setoff_general.sh sv_probe.py --optimize 1 --statistics 1 --width 0.125 --batchsize 256 --num_epochs  $i --seed $j --net svhn_width0.125_abs_fact_pre_bn_resnet18 
    #
    ...
    #
    #bash setoff_general.sh long_cifar.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j --net final_ok_retry_llnl_graphs_width4_abs_fact_pre_bn_resnet18 
    #bash setoff_general.sh long_cifar.py --width 2 --batchsize 512 --num_epochs  $i --seed $j --net final_ok_retry_llnl_graphs_width2_abs_fact_pre_bn_resnet18 
    ...
    #bash setoff_general.sh long_cifar.py --width 0.5 --batchsize 256 --num_epochs  $i --seed $j --net final_ok_retry_llnl_graphs_width0.5_abs_fact_pre_bn_resnet18 
    #bash setoff_general.sh long_cifar.py --width 0.25 --batchsize 256 --num_epochs  $i --seed $j --net final_ok_retry_llnl_graphs_width0.25_abs_fact_pre_bn_resnet18 
