...
def save_model(args, model):
    ...
    model_dir =  src + args.net + "_rank" + str(args.channel_k) + "_width" + str(args.width) + "_" + args.nonlinearity+ "-seed" + str(args.seed)
...
parser.add_argument('--nonlinearity', type=str, default='abs')
