...
do
  ...
  do
    echo $i
    #retry_r
    bash setoff_general.sh long_cifar.py  --width 4 --batchsize 1024 --num_epochs  $i --seed $j --resample 1 --net state_switch_aligned_llnl_graphs_width4_abs_pre_bn_aligned_resnet18 
    #bash setoff_general.sh double_cifar.py  --width 4 --batchsize 512 --num_epochs  $i --seed $j --resample 1 --net state_switch_aligned_llnl_graphs_width4_abs_pre_bn_aligned_resnet18 
