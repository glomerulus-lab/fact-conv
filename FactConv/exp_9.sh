...
do
  ...
  # 
    ...
    sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 200 --batchsize $i --net factmlp --resample_freq 0 --epochs 100
    #sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 200 --batchsize $i --net alignment --resample_freq 0 --epochs 100
    #sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 200 --batchsize $i --net alignment --resample_freq 3 --epochs 100
    if (( $i >  400 )); then
      #sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 500 --batchsize $i --net alignment --resample_freq 0 --epochs 100
      sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 500 --batchsize $i --net factmlp --resample_freq 0 --epochs 100
    #  sbatch setoff_general.sh test_float.py --layer 20 --niters $j --eps 0.000 --rank 500 --batchsize $i --net alignment --resample_freq 3 --epochs 100
    fi
  done
done
