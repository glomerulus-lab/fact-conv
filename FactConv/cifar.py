...
def save_model(args, model):
    src= "../saved-models/Cifar_ResNets/"
    run_name = "{}_{}_resample_{}_width_{}_seed_{}".format(args.net,
            args.double, args.resample, args.width, args.seed)
...
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=64, shuffle=True,drop_last=True,  num_workers=8)

testset = torchvision.datasets.CIFAR10(
    root='./data', train=False, download=True, transform=transform_test)
testloader = torch.utils.data.DataLoader(
    testset, batch_size=64, shuffle=False,drop_last=True, num_workers=8)
...
run_name = "{}_{}_resample_{}_width_{}_seed_{}".format(args.net, args.double,
        args.resample, args.width, args.seed)
...
run = wandb.init(project="FactConv", config=args,
        group="testing_cifar_pre_bn", name=run_name, dir=wandb_dir)
