# Script to run RSN model with Learnable Covariance on CIFAR10
...
if __name__ == '__main__':
    ...
    model = LC_CIFAR10(args.hidden_dim, args.s, args.f, args.scale, args.bias, args.freeze_spatial, args.freeze_channel, args.spatial_init).to(device)
