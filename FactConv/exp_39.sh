...
do
  ...
  do
    ...
    #bash setoff_general.sh long_cifar.py --width 2 --batchsize 512 --num_epochs  $i --seed $j --net width2_abs_eigh_pre_bn_resnet18 
    bash setoff_general.sh long_cifar.py --width 4 --batchsize 1024 --num_epochs  $i --seed $j --net width4_abs_eigh_pre_bn_resnet18 
